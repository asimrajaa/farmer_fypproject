...
const Seller = () => {
  return (
    <div><section className="h-screen bg-white dark:bg-gray-900">
    <div className="py-8 px-4 mx-auto max-w-screen-md text-center lg:py-16 lg:px-12">
        ...
        <p className="font-light text-gray-500 md:text-lg xl:text-xl dark:text-gray-400">WILL BE COMPLETE AFTER DEMO.</p>
    </div>
</section></div>
  )
}
